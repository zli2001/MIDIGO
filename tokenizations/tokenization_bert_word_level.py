...
class BertTokenizer(PreTrainedTokenizer):
    ...
    def __init__(self, vocab_file, do_lower_case=False, do_basic_tokenize=True, never_split=None,
...
class BasicTokenizer(object):
    ...
    def __init__(self, do_lower_case=False, never_split=False, tokenize_chinese_chars=False):
